public class Main {
    public static void main(String[] args) {
        ...
        Vehicle v2 = new MilitaryTank(); // Prints “Tank created.

// 2000 miles to go!”
        v1.drive(); 		// Prints “Car didn’t drive - there’s
//no driver!”
        v2.drive(); 		// Prints “Tank didn’t drive - there’s
// no driver!”
        v1.setDriver(d1); 	// Prints “Driver not changed! Emilia is 17, but
        // must be 18 or older to drive car”



        v1.setDriver(d2); 	// Prints “Driver changed to Niklas”
        v2.setDriver(d2); 	// Prints “Driver not changed! Niklas is 21,
